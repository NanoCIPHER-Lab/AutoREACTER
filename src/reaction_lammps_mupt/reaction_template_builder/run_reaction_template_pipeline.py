...
def reaction_selector(selected_reactions_dict):
    ...
    for key, reaction in selected_reactions_dict.items():
        ...
        combined_reactants_with_map_nums, combined_products_with_map_nums = Chem.Mol(combined_reactants), Chem.Mol(combined_products) # Keep copies with map numbers for debugging
