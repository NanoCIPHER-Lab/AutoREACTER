...
class FunctionalGroupsDetector:
    ...
    def functional_groups_detector(self, monomer_dictionary: dict) -> dict:
        """
        ...
        for indexm, smiles in monomer_dictionary.items():
            ...
            for functional_group in self.monomer_types.values():
                ...
                if functional_group["functionality_type"] == "vinyl":
                    functionality, functional_count_1, functional_count_2 = self.detect_monomer_functionality(
                        smiles,
                    ...
                    if functionality >= 1:
                        ...
                        if indexm not in self.selected_monomers:
                            self.selected_monomers[indexm] = {"smiles": smiles}
                        self.selected_monomers[indexm][functional_group_index] = {
                            "functionality_type": "vinyl",
        ...
        # print(f"Selected monomers after functionality detection: {json.dumps(selected_monomers, indent=4)}")
        return self.selected_monomers   
...
if __name__ == "__main__":
    ...
    print(json.dumps(detector.functional_groups_detector(monomer_dictionary), indent=4))
